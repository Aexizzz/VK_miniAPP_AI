  ...
  return (
    <>
      <div className="Content-Title">
        ...
        <h3 className='ttp-Title_2-emphaized Content-Title-Title'>Сообщества для вас, {userFirstName}</h3>
      </div>
      ...
      <div className="HorList">
        ...
        <RowTitle
          type='Default'
          title='Сообщества, которые могут вам понравится'
        />
      ...
      <div className="HorList">
        ...
        <RowTitle
          type='Plus'
          title='МИДИС | Международный институт дизайна и сервиса'
          subtitle='На основе вашего интереса к:'
          cover=''
        />
        <div className="HorList-Scroll">
          <div className="HorList-Items">
